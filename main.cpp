...
int main() {
	...
	vehiclesArray[7] = new Jet("Boeing", "737", "Rocket", 5);
	vehiclesArray[8] = new Boat();
	vehiclesArray[9] = new Boat("Yamaha", "SX190", "Diesel", 2); 
	vehiclesArray[10] = new Skateboard("Penny", "Board");
